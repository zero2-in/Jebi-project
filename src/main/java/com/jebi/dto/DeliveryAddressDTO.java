...
public class DeliveryAddressDTO {
    ...
    // 리스트
    public DeliveryAddressDTO(String no, String cons_zip, String cons_addr, String cons_addr_det, String cons_nm_kr, String cons_nm_en, String mob_no, String person_ctms_no) {
        this.no = no;
        this.cons_zip = cons_zip;
        this.cons_addr = cons_addr;
        this.cons_addr_det = cons_addr_det;
    ...
    // 상세보기 (수정)
    public DeliveryAddressDTO(String no, String reg_id, String cons_zip, String cons_ckbaseyn, String cons_addr, String cons_addr_det, String cons_nm_kr, String cons_nm_en, String mob_no, String person_ctms_no) {
        this.no = no;
        this.reg_id = reg_id;
        this.cons_zip = cons_zip;
        this.cons_ckbaseyn = cons_ckbaseyn;
