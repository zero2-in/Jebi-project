        ...
        <div class="dashboard margin-bottom-40">
            ...
            <div class="content">
                <ul class="dashboard-box-list">
                    ...
                    <li>
                        <div class="submit-field margin-bottom-0">
                            <input type="text" name="t_sub_title" class="with-border"value="${dto.getSub_title()}">
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="submit-field">
                            ...
                            <div id="summernote"><p style="text-align: center; " align="center"><img src="file_room/event/${dto.getNo()}_${dto.getAttach()}" width="792"><br style="clear:both;"></p>${dto.getContent()}</div>
                        </div>
                    </li>
                    <li>
                        <div class="submit-field margin-bottom-0">
