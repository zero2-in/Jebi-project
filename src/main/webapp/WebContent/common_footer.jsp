        ...
        <div class="informationuse">
            <div class="content">           
                <ul>
                    ...
                    <li><div class="terms-of-use"><a href="javascript:goSite('termsofuse')">이용약관</a></div></li>
                    <li><div class="privacy"><a href="javascript:goSite('privacystatement')">개인정보수집방침</a></div></li>
