...
<link rel="stylesheet" href="css/invoice_number_list.css">
...
<div id="container">
  ...
  <div class="informationuse">
    ...
    <div class="informationuse-title"><p>송장번호 확인하기</p>
    ...
    <div class="invoice-number-content">
      <div class="invoice-number-pc">[PC 조회 방법]</div>
      <div class="invoice-number-pc-manual"><img src="images/invoice_number_pc_manual_img.jpg" height="120px"></div>
      <div class="invoice-number-pc-manual01"><img src="images/invoice_number_pc_manual01_img.jpg" height="231px"></div>
      <div class="invoice-number-pc-manual02"><img src="images/invoice_number_pc_manual02_img.jpg" height="260px"></div>
      <div class="invoice-number-pc-manual03"><img src="images/invoice_number_pc_manual03_img.jpg" height="444px"></div>
      <div class="invoice-number-mobile">[모바일 조회 방법]</div>
      <div class="invoice-number-mobile-manual01"><img src="images/invoice_number_mobile_manual01_img.jpg" height="961px"></div>
      <div class="invoice-number-mobile-mypage">我的淘宝（마이페이지)를 클릭합니다.</div>
      <div class="invoice-number-mobile-manual02"><img src="images/invoice_number_mobile_manual02_img.jpg" height="961"></div>
      <div class="invoice-number-mobile-purchase-history">查看更多订单(구매내역 보기) 클릭합니다.</div>
      <div class="invoice-number-mobile-manual03"><img src="images/invoice_number_mobile_manual03_img.jpg" height="961"></div>
      <div class="invoice-number-mobile-logistics-view">트래킹 넘버를 확인하고 싶은 제품의<br>查看物流（물류보기）클릭.<br><br>물류 보기에서 트래킹 넘버, 택배회사,<br>배송 현황 확인이 가능합니다.<br></div>
      <div class="invoice-number-mobile-manual04"><img src="images/invoice_number_mobile_manual04_img.jpg" height="961px"></div>
    </div>
    <!-- Content  End -->
  </div>
  <!-- Informatio Use End-->
