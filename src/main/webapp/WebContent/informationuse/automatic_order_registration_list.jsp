...
<link rel="stylesheet" href="css/automatic_order_registration_list.css">
...
<div id="container">
    ...
    <div class="informationuse">
        ...
        <div class="informationuse-title"><p>주문자동등록방법</p>
        ...
        <!-- Content  Start -->
        <div class="automatic-order-registration-content">
            <div class="automatic-order-registration-manual"><img src="images/automatic_order_img.jpg" height="120px"></div>
            <div class="automatic-order-registration01-manual"><img src="images/automatic_order_registration01_img.jpg" height="231px"></div>
            <div class="automatic-order-registration02-manual"><img src="images/automatic_order_registration02_img.jpg" height="532px"></div>
            <div class="automatic-order-registration03-manual"><img src="images/automatic_order_registration03_img.jpg" height="536"></div>
            <div class="automatic-order-registration04-manual"><img src="images/automatic_order_registration04_img.jpg" height="481px"></div>
            <div class="automatic-order-registration05-manual"><img src="images/automatic_order_registration05_img.jpg" height="424px"></div>
        </div>
        <!-- Content  End -->
