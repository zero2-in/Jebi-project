...
<link rel="stylesheet" href="css/business_user_guide_list.css">
...
<div id="container">
    ...
    <div class="informationuse">
        ...
        <div class="informationuse-title"><p>사업자 이용안내</p>
            <nav id="breadcrumbs" class="dark">
                <ul class="nav-list">
                    <li><a href="../index.html">Home</a></li>
                    <li>이용안내</li>
                    <li class="select-area">
                        <button class="dropbtn">사업자 이용안내<span class="bs-caret"><span class="caret"></span></span></button>
                        <div class="dropdown-content">
                            ...
                            <a href="javascript:goSite('business_user_guide_list')">사업자 이용안내&nbsp;&nbsp;&nbsp;<i class="fas fa-check"></i></a>
        ...
        <!-- Content  Start -->
        <div class="business-user-guide-content">
            <div class="business-user-guide-manual"><img src="images/business_user-guide_img.jpg" height="120px"></div>
            <div class="buisnessman-member"><img src="images/buisnessman_member.jpg" height="302px"></div>
