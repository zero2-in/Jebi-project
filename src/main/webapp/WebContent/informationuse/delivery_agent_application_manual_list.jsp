...
<link rel="stylesheet" href="css/delivery_agent_application_manual_list.css">
...
<div id="container">
    ...
    <div class="informationuse">
        ...
        <div class="informationuse-title"><p>배송대행 신청서 작성법</p>
                ...
                <ul class="nav-list">
                    ...
                    <li class="select-area">
                        ...
                        <div class="dropdown-content">
                            <a href="javascript:goSite('delivery_agent_service_list')">배송대행 이용방법&nbsp;&nbsp;&nbsp;<i class="fas fa-check"></i></a>
        ...
        <!-- Content  Start -->
        <div class="application-manual-content">
            <div class="application-manual"><img src="images/delivery_agent_application_manual_img.jpg" height="120px"></div>
            <div class="application-for-delivery-agency"><img src="images/application_for_delivery_agency_img.jpg" height="756px"></div>
            <div class="logistics-center"><img src="images/logistics_center_img.jpg" height="547"></div>
            <div class="product-information"><img src="images/product_information_img.jpg" height="809px"></div>
            <div class="addition-service"><img src="images/addition_service_img.jpg" height="1215px"></div>
        </div>
        <!-- Content  End -->
