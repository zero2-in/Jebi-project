...
<link rel="stylesheet" href="css/issuance_of_unique_number_list.css">
...
<div id="container">
  ...
  <div class="informationuse">
    ...
    <div class="informationuse-title"><p>개인통관고유부호 발급</p>
    ...
    <!-- Content  Start -->
    <div class="issuance-of-unique-number-content">
      <div class="issuance-of-unique-number-manual"><img src="images/issuance_of_unique_number_img.jpg" height="120px"></div>
      <div class="issuance-of-unique-number01-manual"><img src="images/issuance_of_unique_number01_img.jpg" height="567px"></div>
      <div class="issuance-of-unique-number02-manual"><img src="images/issuance_of_unique_number02_img.jpg" height="459"></div>
      <div class="issuance-of-unique-number03-manual"><img src="images/issuance_of_unique_number03_img.jpg" height="308px"></div>
      <div class="issuance-of-unique-number04-manual"><a href="https://unipass.customs.go.kr/csp/persIndex.do"><img src="images/issuance_of_unique_number04_img.jpg" height="50px"></a></div>
    </div>
    <!-- Content  End -->
