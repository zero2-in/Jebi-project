...
<div class="container-agent">
    ...
    <!-- 수취인 주소 -->
    <form name="board" action="PurchaseAgent" method="post">
                ...
                <div class="dashboard-box margin-top-0">
                    ...
                    <div class="headline">
                        ...
                        <div class="headline-btn">
                            <a href="#small-dialog" onclick="fnPopup('MemAddrPop_L')" data-animation="ripple" class="popup-with-zoom-anim button blue-line ripple-effect">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-common">
                                            <div class="submit-field">
                                                ...
                                                <div class="clearfix"></div>
                                                <input type="text" name="t_address_1" placeholder="주소" value="" class="with-border margin-top-10 gray-read">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-common">
                                            <div class="submit-field">
                                                ...
                                                <a href="#samll-dialog" onclick="jusoSearch()" data-animation="ripple" class="popup-with-zoom-anim button gray ripple-effect fl">우편번호 검색</a>
                                                <div class="clearfix"></div>
                                                <input type="text" name="t_address_1" placeholder="주소" value="${ckbase_dto.getCons_addr()}" class="with-border margin-top-10 gray-read">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-common">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-common">
                                                <div class="submit-field">
                                                    <input type="text" name="t_item_eng_name" maxlength="100" placeholder="상품명 영문" class="with-border necessary">
                                                    <div class="tip-text margin-top-10">
                                                        <span>*</span>
