...
<div class="container-find-id-pw">
  ...
  <div class="content01">
    <div class="tab">
      <ul class="tabnav">
        <li><a href="#tab01"><b>아이디 찾기</b></a></li>
        <li><a href="#tab02"><b>비밀번호 재발급</b></a></li>
      </ul>
    </div>
        ...
        <div class="board-find-id-pw">
          <div class="form-find-id-pw">
            ...
            <p class="box-text">
              ...
              <input type="text" class="input" name="name"  placeholder="성명" autofocus onkeypress="if(event.keyCode == '13') login.password.focus();">
            </p>
            <p class="box-text">
