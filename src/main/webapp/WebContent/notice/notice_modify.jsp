                    ...
                    <li>
                        <div class="submit-field">
                            <select class="with-border" style="cursor: pointer" name="t_important">
                                <option value="" <c:if test="${dto.getImportant() eq 'N'}">selected</c:if> > = 공지설정 </option>
                                <option value="1" <c:if test="${dto.getImportant() eq 'Y'}">selected</c:if>  >최고중요</option>
                                <option value="2" <c:if test="${dto.getImportant() eq 'X'}">selected</c:if> >부제목</option>
                            </select>
                        </div>
                    </li>
