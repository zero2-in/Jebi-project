...
<script>
    $(document).ready(function () {
        $("#breadcrumbs #pageTitle").html("포인트 내역");
        $("#breadcrumbs .point_history").addClass("selected");
        $("#breadcrumbs .point_history").attr("href", "javascript:void(0)");
    });
</script>
                                ...
                                <div class="board-listing width-adjustment">
                                    <div class="board-listing-details">
                                        <div class="board-listing-description">
                                            <h3 class="board-listing-title">포인트 이용 내역이 없습니다.</h3>
                                        </div>
                                    </div>
                                </div>
                            </li>
