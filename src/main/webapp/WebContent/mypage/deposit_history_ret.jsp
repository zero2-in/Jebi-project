                ...
                <form action="" name="frmDpst" method="post">
                    <div class="content">
                        <ul class="dashboard-box-list">
                            <li>
                                <div class="row">
                                    <div class="col-xl-3 col-common">
                                        <div class="submit-field">
                                            <input type="text" name="MNY" class="with-border" placeholder="환불금액(￦)">
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-common">
                                        <div class="submit-field">
                                            <input type="text" name="MNY" class="with-border" placeholder="예금주">
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-common">
                                        <div class="submit-field">
                                            <input type="text" name="MNY" class="with-border" maxlength="40" placeholder="은행명">
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-common">
                                        <div class="submit-field">
                                            <input type="text" name="MNY" class="with-border" maxlength="40" placeholder="환불금 수령 계좌번호">
                                        </div>
                                    </div>
                                </div>
                            </li>
                                ...
                                <div class="board-listing width-adjustment">
                                    <div class="board-listing-details">
                                        <div class="board-listing-description">
                                            <h3 class="board-listing-title">환불 내역이 없습니다.</h3>
